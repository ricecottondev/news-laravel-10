 ...
 @section('content')
 <section class="pt-1">
 	<div class="source-news text-bg-warning text-center py-1 mb-3 d-md-flex flex-wrap align-items-md-center justify-content-md-center column-gap-md-4">
 		<div class="container-lg">“We read everything — SMH, ABC, Nine, Seven, SBS, 10News, The Guardian, anyone who does journalism,
