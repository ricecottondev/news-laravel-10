...
@section('content')
                            ...
                            <main class="d-flex flex-column row-gap-4">
                                ...
                                <section class="ps-xl-4 px-xxl-5 fs-5 lh-lg">
                                    ...
                                    <div class="mt-4" style="font-size: 11px; font-style: italic">
                                        ...
                                        Factabot provides satirical commentary based on real-world events covered by major
                                        Australian news outlets.
                                        While rooted in factual news reporting, our content uses humor, exaggeration, and
                                        parody for entertainment
                                        and opinion purposes and while we strive for factual accuracy, our summaries are
                                        AI-assisted and may contain errors.
                                        ...
                                        reporting.
                                        Always check trusted news sources (like ABC, Nine, SMH, etc.) for original
                                        reporting.
                                    </div>
                                </section>
                            </main>
                        ...
                        <div class="col px-3">
                            ...
                            <div class="d-flex flex-column row-gap-5 small">
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('front.news.show', ['slug' => $slugrandomsimilarnews]) }}"
                                            ...
                                            <figure class="figure">
                                                ...
                                                <figcaption class="figure-caption">
                                                    <p class="mb-0"><small><small>News - <b
                                                                    class="fw-bold">{{ $pn->countriesCategoriesNews->first()?->category?->name ?? 'No Category' }}</b></small></small>
                                                    </p>
                                ...
                                <form action="{{ route('news.comment', $news->id) }}" method="POST">
                                        ...
                                        <div class="row gx-2">
                                            <div class="col">
                                                <div class="form-check p-0 m-0">
                                                    <input type="radio" class="btn-check" name="emoji"
                                                        id="emoji1" value="funny" autocomplete="off">
                                                    <label class="btn btn-sm btn-outline-success fs-4 w-100"
                                                        for="emoji1">😀</label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-check p-0 m-0">
                                                    <input type="radio" class="btn-check" name="emoji"
                                                        id="emoji2" value="woke" autocomplete="off">
                                                    <label class="btn btn-sm btn-outline-warning fs-4 w-100"
                                                        for="emoji2">😮</label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-check p-0 m-0">
                                                    <input type="radio" class="btn-check" name="emoji"
                                                        id="emoji3" value="mad" autocomplete="off">
                                                    <label class="btn btn-sm btn-outline-danger fs-4 w-100"
                                                        for="emoji3">😠</label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    @guest
                                        <input type="text" name="guest_name"
                                            class="form-control border-light rounded-0 mb-2" placeholder="Your Name"
                                            value="" required>
                                    @endguest
                                    ...
                                    <div class="form-group mb-2">
                                        <textarea name="comment" rows="6" class="form-control border-light rounded-0"
    ...
    <nav class="fixed-bottom end-0 m-3" style="left: unset;">
        <button class="btn btn-lg btn-warning" data-bs-toggle="modal" data-bs-target="#modalRequest">
    ...
    <div class="modal fade" id="modalRequest" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form id="requestNewsForm" class="modal-content">
                <div class="modal-header border-0">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Form Request a Roast</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                ...
                <div class="modal-body bg-dark text-white">
                    ...
                    <textarea name="request" class="form-control" placeholder="Request a Roast" rows="4" required></textarea>
                </div>
    ...
    <script>
        document.getElementById('requestNewsForm').addEventListener('submit', function(e) {
            e.preventDefault();
            ...
            fetch("/request-news", {
                ...
                .then(data => {
                    if (data.success) {
                        alert(data.message);
                        document.getElementById('requestNewsForm').reset();
                        var modal = bootstrap.Modal.getInstance(document.getElementById('modalRequest'));
