               ...
               <div class="col order-md-1">
                  ...
                  <div class="news-time media small">
                     ...
                     <div class="media-body">
                        <div class="mb-1">
                           <small class="opacity-75">Author by</small>
                           <b class="fw-medium">{{ $items[0]->author->name ?? 'Admin' }}</b>
                        </div>
               ...
               <div class="col order-md-1">
                  ...
                  <div class="news-time media small">
                     ...
                     <div class="media-body">
                        <div class="mb-1">
                           <small class="opacity-75">Author by</small>
                           <b class="fw-medium">{{ $items[1]->author->name ?? 'Admin' }}</b>
                        </div>
               ...
               <div class="col order-md-1">
                  ...
                  <div class="news-time media small">
                     ...
                     <div class="media-body">
                        <div class="mb-1">
                           <small class="opacity-75">Author by</small>
                           <b class="fw-medium">{{ $items[2]->author->name ?? 'Admin' }}</b>
                        </div>
