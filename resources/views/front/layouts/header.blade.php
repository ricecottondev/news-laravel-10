...
<marquee id="breaking-news" behavior="" direction="">Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque blanditiis iure voluptatibus similique odio culpa, iste numquam vitae possimus nam ipsam exercitationem dicta minima accusamus totam delectus perferendis! Tempore, necessitatibus.
</marquee>
    ...
    fetch(apiUrl)
        ...
        .then(data => {
            ...
            categories.forEach(category => {
                const categoryLink = `<a class="text-white text-decoration-none me-3" href="/newscategory/${category.name}">${category.name}</a>`;
                categoryMenu.innerHTML += categoryLink;
                mobileCategoryMenu.innerHTML += `<a class="text-white text-decoration-none py-2" href="/newscategory/${category.name}">${category.name}</a>`;
        ...
        .catch(error => {
            ...
            document.getElementById("category-menu").innerHTML = "<span class='text-warning'>Failed to load categories</span>";
