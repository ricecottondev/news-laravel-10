...
<!-- Bootstrap Modal -->
<div class="modal fade" id="newsPopupModal" tabindex="-1" aria-labelledby="contributorModalLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="background-color: #1d1b18; color: #f5f0e6; border-radius: 1rem; overflow: hidden;">
            <div class="modal-body p-5">
                ...
                <div id="formSection">
                    <form id="contributorForm">
                        <h1 class="text-danger fw-bold mb-4 text-center" style="font-size: 2rem;">You're Early. And Kinda Legendary.</h1>
                        ...
                        <p class="mb-4" style="color: #cba34e; font-size: 1.1rem;">
                            We’re building this chaos machine with your feedback, and we want to <strong>immortalize you</strong> on our <strong>Founding Contributors Wall</strong>—a forever list of legends who helped shape it.
                        </p>
                        <p class="mb-4" style="color: #cba34e; font-size: 1.1rem;">
                        ...
                        <input type="email" id="email" name="email" class="form-control mb-3" placeholder="Your Email" required>
                ...
                <div id="thankYouSection" class="d-none text-center">
                    ...
                    <h1 class="fw-bold mb-4 text-danger text-uppercase" style="font-size: 1.8rem;">You Beautiful<br>Beta Hero, You.</h1>

                    <p class="mb-4" style="color: #cba34e; font-size: 1.1rem;">
                        Your name’s in. Your place in Factabot history is secured.
                    </p>
                    <p class="mb-4" style="color: #cba34e; font-size: 1.1rem;">
                        Thanks for helping us build something smarter, sassier, and way less corporate than whatever the algorithm served you yesterday.
                    </p>
                    <p class="mb-4" style="color: #cba34e; font-size: 1.1rem;">
                        Now go break something else in the app—we’re watching (in a totally non-creepy way).
                    </p>
                    <a href="/" class="btn btn-danger fw-bold px-5 py-2" style="font-size: 1.2rem;">Back to the Headlines</a>
                </div>
            </div>
